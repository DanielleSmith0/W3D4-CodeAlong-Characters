...
function getAllChars(){
  ...
  }).catch((err) => console.log({err: err, "message": "Problem getting all characters"}));
//The curly brackets inside the console log label the info as an object.
//let obj={
//   err: err, 
//   message: "Problem getting all characters"
// }
}
...
function addChar(e){
  ...
  axios.post(`${baseURL}/character`, body).then(result => {
    result.data.forEach(char => createCharacterCard(char));
  }).catch(err => console.log({err, message: "Error adding character"}));
}
